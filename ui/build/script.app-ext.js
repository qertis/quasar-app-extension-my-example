...
module.exports.syncAppExt = (both = true) => {
    ...
    // check dependencies
    if (appExtJson.dependencies !== void 0 && appExtJson.dependencies[name] !== void 0) {
        appExtJson.dependencies[name] = '^' + version
        finished = true
    }
    // check devDependencies, if not finished
    if (finished === false && appExtJson.devDependencies !== void 0 && appExtJson.devDependencies[name] !== void 0) {
    ...
    if (finished === true) {
        ...
        console.log(` ⭐️ App Extension version ${appExtJson.name} synced with UI version.\n`)
        return
    }
